...
const int trigPin1 = 2;//Trigger pin of frontside ultrasonic sensor connected to pin no:13
const int echoPin1 = 3;//Echo pin of frontside ultrasonic sensor connected to pin no:12
//defines ultrasonic leftside sensor pins
const int trigPin2 = 4;//Trigger pin of leftside ultrasonic sensor connected to pin no:3
const int echoPin2 = 5;//Echo pin of leftside ultrasonic sensor connected to pin no:2
