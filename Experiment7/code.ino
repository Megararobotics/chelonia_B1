...
const int motor1Dir2 = 7; // Direction input 2 for Motor 1
 
const int motor2PWM = 3;  // PWM input for Motor 2
const int motor2Dir1 = 5; // Direction input 1 for Motor 2
const int motor2Dir2 = 4; // Direction input 2 for Motor 2
